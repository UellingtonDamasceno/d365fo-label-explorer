...
export const translations = {
  en: {
    ...
    extractor_apply_confirm: 'Apply {count} label replacements to project files? A backup will be created.',
    extractor_creating_backup: 'Creating backup...',
    extractor_processing_replacements: 'Processing replacements...',
    extractor_writing_files: 'Writing files to disk...',
    extractor_adding_to_builder: 'Adding labels to Builder...',
    ...
    extractor_rollback_success: 'Restored {count} file(s) successfully.',
    extractor_rollback_error: 'Failed to perform rollback.',
    extractor_no_backups: 'No backups found to rollback.',
  ...
  'pt-BR': {
    ...
    extractor_apply_confirm: 'Aplicar {count} substituições de label nos arquivos do projeto? Um backup será criado.',
    extractor_creating_backup: 'Criando backup...',
    extractor_processing_replacements: 'Processando substituições...',
    extractor_writing_files: 'Gravando arquivos em disco...',
    extractor_adding_to_builder: 'Adicionando labels ao Builder...',
    ...
    extractor_rollback_success: '{count} arquivo(s) restaurado(s) com sucesso.',
    extractor_rollback_error: 'Falha ao executar rollback.',
    extractor_no_backups: 'Nenhum backup encontrado para rollback.',
    btn_select_project: '.rnrproj',
    btn_close: 'Fechar',
